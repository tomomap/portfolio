        ...
        <section className="mb-15 ms:mb-32">
          ...
          <div className="border border-[#D6D3CC] bg-white p-7 ms:p-10">
            ...
            <p className="mt-8 text-[15px] leading-7 text-[#444]">
              プロジェクトの追加・編集・削除、検索、ステータス変更、<br />並び替えなどを実装したプロジェクト管理アプリです。<br />
              「登録する → 整理する → 状況を確認する」という基本的な操作を、実際に触ってお試しいただけます。</p>
              <p className="mt-3 text-[15px] leading-7 text-[#444]">サンプルのため、入力したデータは保持されません。</p>
            <div className="mt-8">
              <a
                href="/projects/"
